  ...
  return (
    <article
      className={`card overflow-hidden ${
        isPremium ? "ring-2 ring-amber-400 border-amber-300" : ""
      }`}
    >
      {isPremium && (
        <div className="flex items-center gap-1.5 bg-amber-50 px-4 py-1.5 text-xs font-semibold text-amber-800 border-b border-amber-200">
      ...
      <div className="p-5">
        ...
        <p className="mt-3 text-sm text-gray-700 line-clamp-2">{listing.shortDescription}</p>
