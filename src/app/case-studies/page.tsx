...
const studies = [
  ...
  },
  {
    ...
    heroStat: "11+",
    heroLabel: "NC Cities Served",
    challenge: "Locally owned parking lot company needed online visibility to reach HOAs, churches, apartment complexes, and retail centers across multiple NC markets.",
    solution: "Premium directory listing, professional website at atlaslotcare.com, and multi-city SEO targeting the Triad, Triangle, and beyond.",
    results: [
      "Premium verified listing serving 11+ NC cities",
      "Professional website driving leads from atlaslotcare.com",
      "Visibility for parking lot striping, ADA compliance, and crack repair searches",
      "Positioned as the go-to locally owned lot care company in NC",
    ],
  },
  {
