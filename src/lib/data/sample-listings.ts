...
export const sampleListings: Listing[] = [
  ...
  },
  {
    ...
    slug: "triad-paving-striping-co",
    description:
      "Triad Paving & Striping Co. is the Piedmont Triad's leading asphalt paving and parking lot striping company. We serve commercial properties, HOAs, municipalities, and residential clients across Greensboro, Winston-Salem, High Point, and surrounding areas. Our services include asphalt paving, sealcoating, crack filling, parking lot striping, ADA compliance markings, curb painting, warehouse floor striping, and road marking. We use premium traffic-grade paint and thermoplastic materials for maximum durability. Fully licensed, insured, and DOT-approved.",
    shortDescription:
      "Commercial & residential asphalt paving, parking lot striping, sealcoating & ADA markings across the Triad.",
    citySlug: "greensboro",
    categorySlug: "paving-striping",
    tier: "premium",
    phone: "3365551013",
    email: "info@triadpaving.com",
    website: "https://triadpaving.com",
    address: "4500 W Market St",
    city: "Greensboro",
    state: "NC",
    zip: "27407",
    latitude: 36.0671,
    ...
    reviewCount: 134,
    yearEstablished: 2008,
    licenseNumber: "NC-58201",
    isVerified: true,
    isFeatured: true,
    tags: ["asphalt paving", "parking lot striping", "sealcoating", "ADA compliance", "line marking", "crack repair"],
    imageUrl: "/images/listings/paving-hero.jpg",
    hours: {
  ...
  {
    id: "14",
    businessName: "Piedmont Asphalt Solutions",
    slug: "piedmont-asphalt-solutions",
    description:
      "Piedmont Asphalt Solutions provides professional paving and striping services in Winston-Salem and throughout Forsyth County. From driveway paving to full commercial parking lot construction and restriping, we deliver quality results on time and on budget.",
    shortDescription:
      "Professional paving & striping in Winston-Salem. Driveways, parking lots & commercial asphalt work.",
    citySlug: "winston-salem",
    categorySlug: "paving-striping",
    tier: "basic",
    phone: "3365551014",
    email: "info@piedmontasphalt.com",
    address: "1200 Peters Creek Pkwy",
    city: "Winston-Salem",
    state: "NC",
    zip: "27103",
    rating: 4.6,
    ...
    isVerified: true,
    isFeatured: false,
    tags: ["driveway paving", "parking lots", "sealcoating", "restriping"],
    createdAt: "2024-02-15",
    updatedAt: "2024-06-01",
  },
  {
    id: "15",
    businessName: "Carolina Pressure Pros",
    slug: "carolina-pressure-pros",
    description:
      "Carolina Pressure Pros provides professional pressure washing services across Greensboro and the Piedmont Triad. We clean driveways, sidewalks, decks, patios, house siding, fences, commercial buildings, parking garages, and dumpster pads. We use commercial-grade hot and cold water equipment with eco-friendly cleaning solutions. Fully insured with $2M liability coverage.",
    shortDescription:
      "Professional pressure washing in Greensboro. Driveways, decks, siding, commercial buildings & parking lots.",
    citySlug: "greensboro",
    categorySlug: "pressure-washing",
    tier: "premium",
    phone: "3365551015",
    email: "info@carolinapressurepros.com",
    website: "https://carolinapressurepros.com",
    address: "3200 Spring Garden St",
    city: "Greensboro",
    state: "NC",
    zip: "27403",
    latitude: 36.0596,
    ...
    isVerified: true,
    isFeatured: true,
    tags: ["pressure washing", "soft wash", "commercial", "driveways", "decks", "house wash"],
    imageUrl: "/images/listings/pressure-washing-hero.jpg",
    hours: {
  ...
  {
    id: "16",
    businessName: "Triangle Clean Wash",
    slug: "triangle-clean-wash",
    description:
      "Triangle Clean Wash is Raleigh's go-to pressure washing company. We specialize in residential soft washing, driveway and patio cleaning, roof cleaning, gutter brightening, and commercial storefront washing. Serving Raleigh, Cary, Apex, Holly Springs, and all of Wake County.",
    shortDescription:
      "Raleigh's top pressure washing company. Soft wash, driveways, roofs & commercial cleaning across Wake County.",
    citySlug: "raleigh",
    categorySlug: "pressure-washing",
    tier: "premium",
    phone: "9195551016",
    email: "info@trianglecleanwash.com",
    website: "https://trianglecleanwash.com",
    address: "5600 Falls of Neuse Rd",
    city: "Raleigh",
    state: "NC",
    zip: "27609",
    latitude: 35.8485,
    ...
    isVerified: true,
    isFeatured: true,
    tags: ["soft wash", "roof cleaning", "driveway cleaning", "commercial", "gutter brightening"],
    hours: {
      monday: "7:00 AM - 7:00 PM",
      tuesday: "7:00 AM - 7:00 PM",
      wednesday: "7:00 AM - 7:00 PM",
