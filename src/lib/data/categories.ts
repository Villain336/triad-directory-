...
export const categories: Category[] = [
  ...
  // Additional High-Traffic Categories
  {
    name: "Tree Service",
    slug: "tree-service",
    description: "Tree removal, trimming, stump grinding, and emergency storm damage cleanup",
    icon: "TreePine",
    featured: true,
  },
  {
  ...
  },
  {
    name: "Siding",
    slug: "siding",
    description: "Vinyl, fiber cement, and wood siding installation, repair, and replacement",
    icon: "Layers",
    featured: false,
  },
  {
    name: "Deck Building",
    slug: "deck-building",
    description: "Custom deck construction, repair, staining, and composite deck installation",
    icon: "Hammer",
    featured: false,
  },
  {
    ...
    description: "Washer, dryer, refrigerator, dishwasher, and oven repair services",
    icon: "Wrench",
    featured: true,
  },
  {
    ...
    description: "HVAC duct cleaning, dryer vent cleaning, and indoor air quality services",
    icon: "Wind",
    featured: false,
  },
  {
    name: "Septic Service",
    slug: "septic-service",
    description: "Septic tank pumping, inspection, repair, and installation services",
    icon: "Droplets",
    featured: false,
  },
  {
    ...
    description: "Standby and portable generator installation, maintenance, and repair",
    icon: "Zap",
    featured: false,
  },
  {
    ...
    description: "Foundation repair, crawl space encapsulation, and basement waterproofing",
    icon: "Shield",
    featured: false,
  },
  {
    name: "Pool Service",
    slug: "pool-service",
    description: "Swimming pool cleaning, maintenance, repair, and installation",
    icon: "Waves",
    featured: false,
  },
  {
    name: "Junk Removal",
    slug: "junk-removal",
    description: "Residential and commercial junk hauling, cleanouts, and debris removal",
    icon: "Trash2",
    featured: true,
  },
  {
    ...
    description: "Chimney sweeping, inspection, repair, and cap installation",
    icon: "Flame",
    featured: false,
  },
];
